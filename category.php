...
$foods=Food::getFoodByCategory($categoryId);
...
<html>
<head>
    <title>World Food | <?php echo $categoryName ?></title>
    <meta charset="utf-8">
    ...
    <div class="divNavBar">
        <ul>
            ...
            foreach($categories as $c){
                echo "<li>";
                if(isset($_GET["categoryId"]) && $_GET["categoryId"] == $c->categoryId) echo "<a class='current'";
                else echo "<a";
                echo " href='category.php?categoryId=".$c->categoryId."'>".$c->categoryName."</a>";
            }
            ?>
        </ul>
    </div>
